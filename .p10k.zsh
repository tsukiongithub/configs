# Generated by Powerlevel10k configuration wizard on 2023-03-09 at 19:08 CET.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND="#e0def4"
  # Custom icon.
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local   modified='%7F'  # yellow foreground
      local  untracked='%7F'   # blue foreground
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND="#e0def4"
